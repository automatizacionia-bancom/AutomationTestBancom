    ...
    public class ClientDataT062600Adapter : IClientDataAdapter<ClientDataT062600>
    {
        public ClientDataT062600 Adapt(DataRow row)
        {
            return new ClientDataT062600
            {
                ...
                MortgageInsurance1 = row.SafeField<MortgageInsuranceType?>("TipoSeguro1") ?? MortgageInsuranceType.Propio,
                MortgageInsurance2 = row.SafeField<MortgageInsuranceType?>("TipoSeguro2") ?? MortgageInsuranceType.Individual,
