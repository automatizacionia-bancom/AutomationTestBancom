...
namespace AutomationTest.FitbankWeb3.Tests
{
    public class DbTest : IClassFixture<TestFixture>
    {
        ...
        public async Task Prueba()
        {
            ...
            //{
            //    Query = "SELECT * FROM FITBANK.TUSUARIOSESIONES WHERE CTERMINAL = 'GJIMENO' AND FHASTA='2999-12-31 00:00:00'",
        ...
        public static void ConvertAllPagesToPng(string pdfPath, string outputFolder, int dpi = 300)
        {
