...
{
    public class LoanApplicationT062800Repository
    {
        ...
        public string LoanTypeList { get; } = "#container_7 > table > tbody > tr:nth-child(1) > td.columna_1 > img:nth-child(2)";
        ...
        public string IncomeOther { get; } = "#c_txtImporte1_10";
