...
{
    public class LoanApplicationT062600Repository
    {
        ...
        public string AdressList { get; } = "#container_3 > div > table > tbody > tr.clonada.par > td:nth-child(11) > img";
        public string AddressElement { get; } = "#entorno-formulario > form:nth-child(7) > div > table > tbody > tr > td:nth-child(1)";
        public string ProductList { get; } = "#container_4 > table > tbody > tr:nth-child(1) > td.columna_1 > img:nth-child(2)";
        public string ManagerList { get; } = "#container_4 > table > tbody > tr:nth-child(1) > td.columna_3 > img:nth-child(2)";
        public string ManagerElement { get; } = "#entorno-formulario > form:nth-child(10) > div > table > tbody > tr:nth-child(1) > td:nth-child(1)";
        public string MortgageInsurance1 { get; } = "#c_chckTipoSeg_0";
        public string MortgageInsurance2 { get; } = "#c_chckClasSeg_0";
        public string MortgageGood { get; } = "#c_chckTipoBien_0";
        public string MortgageProject { get; } = "#c_chckTipoProyecto_0";
        public string MortgageGrade { get; } = "#c_chckGrado_0";
        public string EstimatedValue { get; } = "#c_txtMtoEstVivienda_0";
        public string DownPayment { get; } = "#c_txtCuotaIni_0";
