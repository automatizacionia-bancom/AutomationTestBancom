...
namespace AutomationTest.FitbankWeb3.Application.Transactions.LoanApplications.PersonalBanking
{
    public class LoanApplicationT062400 : LoanApplication<ClientDataT062400>
    {
        ...
        { }
        public override async Task<ILoanApplicationResult> ApplyForLoanAsync(IPage page, LoanApplicationModel<ClientDataT062400> loanApplication)
        {
            ...
            await page.Locator(_locators.DashboardPage.TransactionInput).FillAsync("062400");
            ...
            await page.Locator(_locators.ApplicationPageT062400.Identification).FillAsync(clientData.Identification);
            await page.Locator(_locators.ApplicationPageT062400.Identification).PressAsync("Enter");
            await page.Locator(_locators.DashboardPage.OK).WaitForAsync(new LocatorWaitForOptions
            {
                State = WaitForSelectorState.Visible
            });

            await page.Locator(_locators.ApplicationPageT062400.AdressList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.AddressElement).ClickAsync();

            // Seleccionamos el producto y gestor
            await page.Locator(_locators.ApplicationPageT062400.ProductList).ClickAsync();
            ...
            await page.Locator(_locators.ApplicationPageT062400.ManagerList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.ManagerElement).ClickAsync();

            // Ingresar numero de lote
            await page.Locator(_locators.ApplicationPageT062400.LotNumber).FillAsync(FlowExtensions.GenerateRandomString(10));
            await page.Locator(_locators.ApplicationPageT062400.LotNumber).PressAsync("Enter");
            await page.Locator(_locators.DashboardPage.OK).WaitForAsync(new LocatorWaitForOptions
            {
                State = WaitForSelectorState.Visible
            });
            ...
            await page.Locator(_locators.ApplicationPageT062400.JewelTypeList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.JewelTypeElement).ClickAsync();

            await page.Locator(_locators.ApplicationPageT062400.JewelSubTypeList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.JewelSubTypeElement).ClickAsync();

            await page.Locator(_locators.ApplicationPageT062400.JewelCaratList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.JewelCaratElement).ClickAsync();

            await page.Locator(_locators.ApplicationPageT062400.JewelConditionList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.JewelConditionElement).ClickAsync();

            await page.Locator(_locators.ApplicationPageT062400.JewelDescription).FillAsync("QA");

            await page.Locator(_locators.ApplicationPageT062400.JewelGrossWeight).FillAsync(clientData.JewelGrossWeight.ToString());
            await page.Locator(_locators.ApplicationPageT062400.JewelGrossWeight).PressAsync("Enter");

            await page.Locator(_locators.ApplicationPageT062400.JewelEmbeddedWeight).FillAsync(clientData.JewelEmbeddedWeight.ToString());
            await page.Locator(_locators.ApplicationPageT062400.JewelEmbeddedWeight).PressAsync("Enter");
            ...
            await page.Locator(_locators.ApplicationPageT062400.CreditData).ClickAsync();
            ...
            string applicationNumber = await page.Locator(_locators.ApplicationPageT062400.ApplicationNumber).InputValueAsync();
            ...
            await page.ClickAndWaitAsync(
                page.Locator(_locators.ApplicationPageT062400.EvaluateButton),
                page.Locator(_locators.DashboardPage.OK),
                page.Locator(_locators.DashboardPage.TransactionError),
                new LocatorWaitForOptions
                {
        ...
        private async Task AssingAdditonalIncomeAsync(IPage page, ClientDataT062400 clientData)
        {
            ...
            await page.Locator(_locators.ApplicationPageT062400.IncomeButtton).ClickAsync();
            ...
            await page.Locator(_locators.ApplicationPageT062400.IncomeCategoryList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.IncomeCategoryElement).ClickAsync();

            await page.Locator(_locators.ApplicationPageT062400.IncomeDescription).FillAsync("QA");
            await page.Locator(_locators.ApplicationPageT062400.IncomeDescription).PressAsync("Enter");

            await page.Locator(_locators.ApplicationPageT062400.IncomeContactNumberList).ClickAsync();
            await page.Locator(_locators.ApplicationPageT062400.IncomeContactNumberElement).ClickAsync();

            await page.Locator(_locators.ApplicationPageT062400.IncomeDate).FillIfEditableAsync(DateTime.Now.AddMonths(-1).ToString("MMyyyy"));
            await page.Locator(_locators.ApplicationPageT062400.IncomeDate).PressAsync("Enter");

            await page.Locator(_locators.ApplicationPageT062400.IncomeAssets).FillIfEditableAsync(clientData.Income.ToString());
            await page.Locator(_locators.ApplicationPageT062400.IncomeOther).FillIfEditableAsync(clientData.Income.ToString());
            ...
            await page.ClickAndWaitAsync(
                page.Locator(_locators.ApplicationPageT062400.IncomeReturn),
                page.Locator(_locators.DashboardPage.OK),
                new LocatorWaitForOptions
                {
                    Timeout = 60000, // 60 seconds timeout
            ...
            await page.Locator(_locators.ApplicationPageT062400.CreditData).ClickAsync(); // Volver a la sección de datos del crédito para continuar con la solicitud
        }
    }
}
